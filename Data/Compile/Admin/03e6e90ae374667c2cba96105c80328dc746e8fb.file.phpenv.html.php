<?php /* Smarty version Smarty-3.1.12, created on 2014-02-22 23:20:39
         compiled from "C:\xampp\htdocs\project\Application\Admin\View\Tool\phpenv.html" */ ?>
<?php /*%%SmartyHeaderCode:1703053003a6b4e3914-37036919%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '03e6e90ae374667c2cba96105c80328dc746e8fb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\project\\Application\\Admin\\View\\Tool\\phpenv.html',
      1 => 1393049054,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1703053003a6b4e3914-37036919',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_53003a6b5c8306_57875941',
  'variables' => 
  array (
    'value' => 0,
    'list' => 0,
...
<?php if ($_valid && !is_callable('content_53003a6b5c8306_57875941')) {function content_53003a6b5c8306_57875941($_smarty_tpl) {?><div class="pageHeader"><form onsubmit="return navTabSearch(this);" action="<?php echo "/project/Public/admin/index.php?c=Tool&a=phpenv";?>
" method="post"><div class="searchBar"><table class="searchContent"><tr><td>PHP配置参数：<input type="text" name="param" value="<?php echo (isset($_POST['param']) ? $_POST['param'] : '');?>
" size="40"/></td><td><div class="subBar"><ul><li><div class="buttonActive"><div class="buttonContent"><button type="submit">提交</button></div></div></li></ul></div></td><?php if ((isset($_POST['param']) ? $_POST['param'] : '')!=null){?>
<td><b><?php echo (isset($_POST['param']) ? $_POST['param'] : '');?>
</b> : <font color="blue"><?php echo (isset($_smarty_tpl->tpl_vars['value']->value)?$_smarty_tpl->tpl_vars['value']->value:'');?>
</font></td><?php }?>
</tr></table></div></form></div><div class="navTab-panel tabsPageContent"><div class="page"><div class="pageFormContent" layoutH="62"><table class="list" width="70%"><tr class="row" style="background:#CAE5E8;"><th colspan="3" class="space" style="color: blue;">Server >></th></tr><?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['loop'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['loop']);
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['max'] = (int)9;
...
</table><br/><table class="list" width="70%"><tr class="row" style="background:#CAE5E8;"><th colspan="3" class="space" style="color: blue;">PHP >></th></tr><?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['loop'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['loop']);
$_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['name'] = 'loop';
$_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['loop'] = is_array($_loop=(isset($_smarty_tpl->tpl_vars['list']->value)?$_smarty_tpl->tpl_vars['list']->value:'')) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['start'] = (int)9;
$_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['show'] = true;
$_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['max'] = $_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['loop'];
$_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['step'] = 1;
if ($_smarty_tpl->tpl_vars['smarty']->value['section']['loop']['start'] < 0)
