<?php /* Smarty version Smarty-3.1.12, created on 2014-03-07 17:50:06
         compiled from "C:\xampp\htdocs\project_test\Application\Admin\View\Attachment\index.html" */ ?>
<?php /*%%SmartyHeaderCode:7409530ee3854e4393-67493581%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '343a374ebe434c3857868dd7f73181204eb99831' => 
    array (
      0 => 'C:\\xampp\\htdocs\\project_test\\Application\\Admin\\View\\Attachment\\index.html',
      1 => 1394185706,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7409530ee3854e4393-67493581',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_530ee3856234a4_94700266',
  'variables' => 
  array (
    'page' => 0,
    'college' => 0,
...
<?php if ($_valid && !is_callable('content_530ee3856234a4_94700266')) {function content_530ee3856234a4_94700266($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\htdocs\\project_test\\Common\\Smarty\\plugins\\function.html_options.php';
?>
<form id="pagerForm" method="post" action="<?php echo "/project_test/index.php?c=Attachment";?>
...
" /></form><div class="pageHeader"><form onsubmit="return navTabSearch(this);" action="<?php echo "/project_test/index.php?c=Attachment&a=".((string)@index)."&programid=30";?>
...
</select></td><td><div class="subBar"><ul><li><div class="buttonActive"><div class="buttonContent"><button type="submit">检索</button></div></div></li><li><div class="button"><div class="buttonContent"><button type="button" onclick="return navTabSearch(this);">刷新</button></div></div></li></ul></div></td></tr></table></div></form></div><div class="pageContent"><div class="panelBar"><ul class="toolBar"><li><a class="add" href="<?php echo "/project_test/index.php?c=Attachment&a=upload";?>
" target="dialog" width = "800" height= "500"><span>添加附件</span></a></li><li><a class="edit" href="<?php echo "/project_test/index.php?c=Attachment&a=update&id={id}";?>
" target="dialog" width="800" height="500"><span>修改附件</span></a></li></ul></div><table class="table" width="100%" layoutH="114"><thead><tr><th orderField="id" class="<?php echo (isset($_smarty_tpl->tpl_vars['page']->value['orderDirection'])?$_smarty_tpl->tpl_vars['page']->value['orderDirection']:'');?>
...
</td><td><a target = "_blank" class="btnLook" href="/project_test/Public/share/upload/<?php echo (isset($_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['address'])?$_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['address']:'');?>
" >预览|</a></td><td><a class="btnSelect" href="<?php echo "/project_test/index.php?c=Attachment&a=download&address=".((string)(isset($_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['address'])?$_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['address']:''))."&create_uid=".((string)(isset($_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['create_uid'])?$_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['create_uid']:''));?>
" >下载</a></td><td><a target="ajaxTodo" href="<?php echo "/project_test/index.php?c=Attachment&a=delete&ids=".((string)(isset($_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['id'])?$_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['loop']['index']]['id']:''));?>
